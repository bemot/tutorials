...
The runs can be downloaded from: http://bit.ly/MAGPIE4.
...
4. You know how to start the evaluation tool **appResultsLocal** of the library **shinyresults** and how you can visualized MAgPIE results with this tool.
