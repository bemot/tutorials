...
The convert function will complete the magclass object: For country-level data, all 249 countries represented in MAGPie need to have a value and be in ISO3 country code.
...
After the function is written and built, try it now with the calcAgGDP function. What is Germany's share of Agricultural GDP in 2010?
