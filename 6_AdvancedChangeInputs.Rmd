...
```
The local repository `input_data` can be located anywhere on your filesystem. You could then add `patch_ndc_usa_190909.tgz` in this folder. 

Hint: If you can't locate your `.Rprofile`, you can use `usethis::edit_r_profile()`.
